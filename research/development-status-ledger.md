...
| Four-relay LCD visual-art menu | PF0530W-written-verify-flashed-art-visual-pending | firmware-visible visual-art source/build continuation plus COM6 live write/verify/readiness proof | `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530W-LIVE-2026-06-02`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530W-VISUAL-ART-2026-06-02`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530V-USER-ACCEPTANCE-2026-06-02`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530V-LIVE-2026-06-02`, `SRC-HITACHI-HD44780U-DDRAM-CGRAM-2026-05-31`, `SRC-NXP-HD44780-4X20-DDRAM-2026-05-31` | PF0530W preserves the PF0530V PCNT encoder path and closed safety surfaces, adds a generated `ART` page, seventh `art_panel` glyph bank, and fixed 4x20 custom-character tile map. COM6 identity, 4 MB rollback backup, staged hashes, write-flash, separate verify-flash, read-only PF0530W readiness monitor, transcript scan, cleanup proof, and zero crash/unsafe markers passed. | Physical ART page visual acceptance and ART render telemetry are not captured because the read-only monitor stayed on HOME and no physical encoder input was exercised. | Use PF0530W as the current written/verify-flashed LCD visual-art image. Next useful action is physical encoder navigation to the ART page with operator visual acceptance, optionally accompanied by read-only monitor evidence. Do not reflash or send serial commands unless a new gate explicitly authorizes it. |
