...
| Four-relay rotary encoder LCD menu input | PF0530O-real-menu-cal-written-verified-input-gap | input-only firmware/docs/audit lineage through PF0530E GPIO-level input proof, PF0530F blocked menu proof, PF0530G LCD init proof, PF0530K interrupt-input live gate, PF0530L LCD/menu UX source plus COM6 live flash/verify/monitor evidence, accepted PF0530L retry interaction, accepted PF0530L LCD glyph/electrical gate, PF0530M non-live source/test behavior update, PF0530N scrolling/XML source/live gates, and PF0530O real-menu calibration source/live gates | `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530O-LIVE-2026-06-01`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530O-REAL-MENU-CAL-2026-06-01`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530N-LIVE-2026-06-01`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530N-SCROLLING-XML-2026-06-01`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530M-2026-06-01`, `SRC-LOCAL-LCD-GLYPH-ELECTRICAL-ACCEPTANCE-2026-05-31`, `SRC-LOCAL-TIER3-COM6-ATTENDED-INTERACTION-PROOF-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530L-LIVE-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530L-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530K-LIVE-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530K-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530H-LIVE-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-BBS-LCD-MENU-PF0530H-2026-05-31`, `SRC-LOCAL-FOUR-RELAY-KY040-LCD-INIT-DIAG-PF0530G-2026-05-30`, `SRC-LOCAL-FOUR-RELAY-KY040-ENCODER-MENU-PF0530F-LIVE-2026-05-30`, `SRC-LOCAL-FOUR-RELAY-KY040-ENCODER-MENU-PF0530F-2026-05-30`, `SRC-LOCAL-FOUR-RELAY-KY040-SERIAL-PINTRACE-PF0530E-2026-05-30`, `SRC-MANUALSPLUS-CYLEWET-KY040-B06XQTHDRR`, `SRC-ENVISTIA-KY040-GUIDE-2026-05-30`, `SRC-LOCAL-FOUR-RELAY-LCD-I2C-TEST-FIRMWARE-2026-05-30`, `SRC-LOCAL-ESP32-XBEE-UART-BRIDGE-FLASH-RETEST-2026-05-30`, `SRC-ESP32-DEVKITC`, `SRC-ESP-IDF-GPIO`, `SRC-ESP-IDF-PCNT`, `SRC-ESPRESSIF-KNOB-1-0-2`, `SRC-ESPRESSIF-BUTTON-4-1-6`, `SRC-BOURNS-PEC11R` | PF0530L serial/menu interaction, LCD visual/glyph readability, low-side I2C/KY-040 voltage domain, and user-confirmed continuity/toggle/current-margin evidence are accepted for the closed LCD/DMM gate. PF0530N source/test proof covers build-time XML validation, generated static firmware/simulator definitions, scroll-list navigation, viewport metadata, grouped multi-row item behavior, selected-row marquee timing, table glyph bank constraints, and 20-character display-bound tests; the PF0530N live gate wrote and verify-flashed PF0530N and captured read-only boot monitor proof with no crash/unsafe markers. PF0530O source/live proof records real-menu calibration constants, disabled boot auto-cycle, COM6 write/verify, and read-only LCD readiness/render/heartbeat proof with zero crash/unsafe markers. | PF0530O user visual/input report, physical encoder/button acceptance, final BBS/XBee payload mapping, relay/load/mains readiness, and broader deployment acceptance remain outside this gate. | Next useful gate is user visual/input report for PF0530O, then a COM6 read-only physical/input capture gate if the user confirms actuation occurred without LCD/menu response. Any future COM6 flash, monitor, serial write, RF/XBee write, relay action, wiring change, DMM/current check, or load/mains work needs a fresh Tier 3 gate. |
