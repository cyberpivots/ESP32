...
- Gate M1 full-service mesh discovery is accepted only as a host simulator and
  ...
  rejection. It does not close live ESP-WIFI-MESH, BLE pairing, Android app,
  router/admin, firmware mapping, flash, serial-write, or live proof gaps.
