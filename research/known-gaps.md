...
- Custom wireless protocol Gate B and Gate C now have simulator-only proof for
  ...
  the DOS-C vision gate plus ESP32 completion gate. Firmware ABI and proposed
  `ADR-0005` analytics export policy still need owner review.
