...
- Custom wireless protocol Gate B and Gate C now have simulator-only proof for
  ...
  analytics retention/export/privacy policy, and a machine-passing
  screenshot/completion transcript format still need owner review.
