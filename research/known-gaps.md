...
- Custom wireless protocol Gate B and Gate C now have simulator-only proof for
  ...
  through the ESP32 Gate C adapter, and a Gate E draft bridge ABI freeze
  candidate. Firmware ABI, analytics retention/export, and live acceptance
  transcript requirements still need owner review.
