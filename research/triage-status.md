...
| BBS UI system operation program | Planned-doc-status-program | Start UI-0 and M2-B as host-only/source-backed planning and evidence slices under `SRC-LOCAL-BBS-UI-SYSTEM-OPERATION-PROGRAM-2026-05-28`; keep runtime API, firmware ABI, bridge ABI, serial ABI, live browser proof, mesh/BLE, PCAP, router/admin, flash, serial writes, and hardware work closed. |
