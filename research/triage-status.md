...
| XBee `XBP9B-DPUT-001 RevF` | Study-cli-added-blocked-live | Use `SRC-LOCAL-XBEE-RADIO-STUDY-2026-05-29` for offline inventory/profile-diff/write-plan behavior and source-backed XCTU/XBee Studio mapping; verify Waveshare adapter serial path, voltage, DIN/DOUT routing, settings backup, and operating constraints before live reads or writes. |
