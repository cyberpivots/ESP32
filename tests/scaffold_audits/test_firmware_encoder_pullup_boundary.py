...
class FirmwareEncoderPullupBoundaryTests(unittest.TestCase):
    ...
    def test_pf0530p_bbs_menu_uses_lcd_init_diag_path(self) -> None:
        ...
        self.assertIn("FR_BBS_ART_PANEL_COUNT 5U", source)
        self.assertIn("fr_bbs_art_panels", source)
        self.assertIn("art_panel_index", source)
        self.assertIn("\"ART NEXT\"", source)
        self.assertIn("\"ART PREV\"", source)
