...
class FirmwareEncoderPullupBoundaryTests(unittest.TestCase):
    ...
    def test_pf0530o_bbs_menu_uses_lcd_init_diag_path(self) -> None:
        source = firmware_source_text()

        self.assertIn("FR_DIAG_FIRMWARE_ID \"PF0530O\"", source)
        self.assertIn("FR_DIAG_FIRMWARE_ID_VALUE \"PF0530O\"", source)
        ...
        self.assertIn("FR_ENCODER_AB_STABLE_SAMPLES 2", source)
        self.assertIn("FR_ENCODER_SW_GUARD_MS 75", source)
        ...
        self.assertIn("cal=real-menu-v1", source)
